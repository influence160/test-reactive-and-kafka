...
public class TestKStreamKStreamOuterJoin extends AbstractStringStringAutoTest {

	public TestKStreamKStreamOuterJoin() {
		super("TestJointure3", 
				List.of(
	...
	public static void main(String[] args) {
		...
		TestKStreamKStreamOuterJoin test = new TestKStreamKStreamOuterJoin();
		test.test();
	}
