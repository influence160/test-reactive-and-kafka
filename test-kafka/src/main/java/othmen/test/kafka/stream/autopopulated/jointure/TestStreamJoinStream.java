...
public class TestStreamJoinStream extends AbstractStringStringAutoTest {

	public TestStreamJoinStream() {
		super("TestJointure3", 
				List.of(
	...
	public static void main(String[] args) {
		...
		TestStreamJoinStream test = new TestStreamJoinStream();
		test.test();
	}
	...
	protected void doKafkaWork() {
        ...
        KStream<String, String> jointure = table2
        		.join(table1, (v2, v1) -> "[" + v2 + " | " + v1 + "]", JoinWindows.of(Duration.ofDays(7)));
