...
public class TestKStreamJoinKTable extends AbstractStringStringAutoTest {

	public TestKStreamJoinKTable() {
		super("TestJointure3", 
				List.of(
	...
	public static void main(String[] args) {
		...
		TestKStreamJoinKTable test = new TestKStreamJoinKTable();
		test.test();
	}
